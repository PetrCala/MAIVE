...
- References should be in the form: Author (Year)
...
- No calls to [`library()`](https://rdrr.io/r/base/library.html) or
...
- **CRAN requests**: Immediately when CRAN requests updates (e.g., for
  policy changes)
...
- File writing: Use [`tempdir()`](https://rdrr.io/r/base/tempfile.html)
  instead of user directories
- Random numbers: Set seed for reproducibility
- Platform differences: Use `skip_on_cran()` for platform-specific tests
- Parallel processing: May cause timing issues, consider sequential for
  CRAN
...
- Path separators: Use
  [`file.path()`](https://rdrr.io/r/base/file.path.html) not paste with
  “/”
...
- **Writing R Extensions**:
  <https://cran.r-project.org/doc/manuals/r-release/WRE.html>
  - Comprehensive guide to R package development
  - Technical details on package structure

### Books and Guides

- **R Packages** (Hadley Wickham & Jennifer Bryan):
  <https://r-pkgs.org/>
...
**Remember**: The CRAN team are volunteers who maintain one of the most
important infrastructure pieces of the R ecosystem. They process
thousands of packages and updates annually. Being patient, polite, and
thorough in your submissions makes their job easier and increases the
likelihood of smooth acceptance.

**Questions?** Refer to this guide, search documentation, and ask the
community before contacting CRAN directly. Most questions have been
answered before.
...
*This guide is maintained as part of the package repository. Updates and
corrections are welcome via pull requests.*
