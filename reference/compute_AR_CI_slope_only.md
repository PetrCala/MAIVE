...
sqrt(w) + z (scaled intercept absorbs b0) 3. Use cluster-robust (CR2)
variance for the z coefficient 4. Test statistic: t_z^2 from the
clustered test 5. Accept b1 if t_z^2 \<= qchisq(0.95, df = 1) = 3.84
