...
This guide explains the complete development and release workflow for the MAIVE package, including when to use Make commands vs. direct script calls.
...
- Properly handle user input via `readline()`
...
**Recommendation**: Use interactive for important releases, automated for quick fixes.
...
**Do NOT automate CRAN submission** - it requires human review and email confirmation.
...
Use before CRAN submission. The interactive version provides more detailed feedback.
...
**Solution**: Interactive scripts should always be called directly, not through Make.
...
*This workflow guide is maintained as part of the MAIVE package repository. Updates and improvements are welcome.*
