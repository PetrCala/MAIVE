...
This document describes how to use the Makefile for efficient MAIVE package development.
...
The Makefile is located at the project root and can be customized for your specific needs. Common customizations:
